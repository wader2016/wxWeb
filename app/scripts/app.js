...
app.run(function ($http,$window,$location,localStorageService,$timeout,ClientFactory) {
  ...
  var weixin = {
    config: {
      url:'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5418e098ef4dffb4&redirect_uri=http%3A%2F%2Fwww.itecerp.cn&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect',
