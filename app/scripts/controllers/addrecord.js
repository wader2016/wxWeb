...
/**
 * @ngdoc function
 * @name wxWebApp.controller:AddrecordCtrl
 * @description
 * # AddrecordCtrl
 * Controller of the wxWebApp
 */
angular.module('wxWebApp')
  .controller('AddrecordCtrl', function ($scope,ClientFactory,localStorageService,$timeout,$location) {
    ...
    $scope.AddAppointment = function () {
      ...
      if($scope.Appointment.Subject !="" && $scope.Appointment.Type !=""){
    ...
    wx.getLocation({
      ...
      success: function (res) {
        ...
        ClientFactory.GetTencentMapLocation(latitude,longitude).then(function (data) {
